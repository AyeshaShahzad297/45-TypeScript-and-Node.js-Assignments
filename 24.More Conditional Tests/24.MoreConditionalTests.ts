...
console.log('Test For Equality: ', 'Red' === 'Red')
console.log('Test For Equality: ', 'Red' as string === 'Blue')
console.log('Test For Inequality: ', 'Red' as string !== 'Blue')
console.log('Test For Inequality: ', 'Red' !== 'Red')
...
console.log("Test for Equality: ", (44 as number) === 45);
console.log("Test for Inequality: ", (44 as number) !== 45);
...
console.log("Test using 'and' operator: ", 6 === 6 && (7 as number) === 5);
console.log("Test using 'or' operator: ", 3 === 3 || (2 as number) === 3);
console.log("Test using 'or' operator: ", (4 as number) === 5 || (6 as number) === 9);

// • Test whether an item is in a array
let colors: string[] = ["blue", "red", "black", "white", "green"];
