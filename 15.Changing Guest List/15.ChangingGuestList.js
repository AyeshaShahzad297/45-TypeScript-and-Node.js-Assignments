...
let guestList1 = ['Alice', 'Rose', 'Anna', 'Robert', 'Emily'];
let message3 = 'You are invited to the dinner party this weekend.';
guestList1.map((i) => console.log(`Hi ${i}, ${message3}\n`));
...
guestList1.map(function (guests) {
